...
class ModelService:
    ...
    def __init__(self):
        ...
        self.classification = ClassificationService(self.base)
    ...
    def load_model_and_datasets(
        ...
        return self.base.load_model_and_datasets(
            model_path, data_path, train_data_path, test_data_path, target_column, test_size, random_state
        )

    # === Analysis Methods (delegated to analysis service) ===

    def get_model_overview(self, payload: Dict[str, Any] = None) -> Dict[str, Any]:
        """Get comprehensive model overview."""
        return self.analysis.get_model_overview(payload)

    def get_classification_stats(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        """Get detailed classification statistics."""
        return self.analysis.get_classification_stats(payload)

    def list_instances(
        self, payload: Dict[str, Any] = None, sort_by: str = "prediction", limit: int = 100
    ) -> Dict[str, Any]:
        """List instances for UI selection."""
        return self.analysis.list_instances(payload, sort_by, limit)

    def get_dataset_comparison(self, payload: Dict[str, Any] = None) -> Dict[str, Any]:
        """Compare train vs test dataset characteristics."""
        return self.analysis.get_dataset_comparison(payload)
    ...
    def compute_feature_importance_advanced(
        ...
        return self.feature.compute_feature_importance_advanced(payload, method, sort_by, top_n, visualization)
    ...
    def get_feature_interactions(
        ...
        return self.feature.get_feature_interactions(payload, feature1, feature2)

    # === Classification Methods (delegated to classification service) ===

    def roc_analysis(self, payload: Dict[str, Any] = None) -> Dict[str, Any]:
        """Compute ROC analysis."""
        return self.classification.roc_analysis(payload)

    def threshold_analysis(self, payload: Dict[str, Any] = None, num_thresholds: float = 0.5) -> Dict[str, Any]:
        """Perform threshold analysis for binary classification."""
        return self.classification.threshold_analysis(payload, num_thresholds)
    ...
    def individual_prediction(self, payload: Dict[str, Any] = None, instance_idx: int = 0) -> Dict[str, Any]:
        ...
        return self.prediction.individual_prediction(payload, instance_idx)
    ...
    def explain_instance(self, payload: Dict[str, Any] = None, instance_idx: int = 0) -> Dict[str, Any]:
        ...
        return self.prediction.explain_instance(payload, instance_idx)
    ...
    def perform_what_if(self, payload: Dict[str, Any] = None, features: Dict[str, Any] = None) -> Dict[str, Any]:
        ...
        return self.prediction.perform_what_if(payload, features)

    # === Dependence Methods (delegated to dependence service) ===

    def get_feature_dependence(self, payload: Dict[str, Any] = None, feature_name: str = None) -> Dict[str, Any]:
        """Get basic feature dependence using SHAP values."""
        return self.dependence.get_feature_dependence(payload, feature_name)

    def partial_dependence(
        self, payload: Dict[str, Any] = None, feature_name: str = None, num_points: int = 20
    ) -> Dict[str, Any]:
        """Compute partial dependence plot data."""
        return self.dependence.partial_dependence(payload, feature_name, num_points)

    def shap_dependence(
        self, payload: Dict[str, Any] = None, feature_name: str = None, color_by: Optional[str] = None
    ) -> Dict[str, Any]:
        """Compute SHAP dependence plot data."""
        return self.dependence.shap_dependence(payload, feature_name, color_by)

    def ice_plot(
        self, payload: Dict[str, Any] = None, feature_name: str = None, num_points: int = 20, num_instances: int = 20
    ) -> Dict[str, Any]:
        """Compute Individual Conditional Expectation plot data."""
        return self.dependence.ice_plot(payload, feature_name, num_points, num_instances)

    # === Interaction Methods (delegated to interaction service) ===

    def interaction_network(
        self, payload: Dict[str, Any] = None, top_k: int = 30, sample_rows: int = 200
    ) -> Dict[str, Any]:
        """Compute feature interaction network analysis."""
        return self.interaction.interaction_network(payload, top_k, sample_rows)
    ...
    def pairwise_analysis(
        ...
        return self.interaction.pairwise_analysis(payload, feature1, feature2, color_by, sample_size)

    # === Tree Methods (delegated to tree service) ===

    def get_decision_tree(self, payload: Dict[str, Any] = None) -> Dict[str, Any]:
        """Extract decision tree structure for visualization."""
        return self.tree.get_decision_tree(payload)

    def get_tree_rules(self, payload: Dict[str, Any] = None, tree_idx: int = 0, max_depth: int = 3) -> Dict[str, Any]:
        """Extract decision rules from a specific tree."""
        return self.tree.get_tree_rules(payload, tree_idx, max_depth)
