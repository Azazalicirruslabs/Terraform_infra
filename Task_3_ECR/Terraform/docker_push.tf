...
#terraform_data: run custom shell commands on local machine.
...
resource "terraform_data" "ecr_login" {
  ...
  # triggers_replace: Hey, whenever I run terraform apply, always re-run this command - don't skip it.
  # for ecr authentication tokens 
