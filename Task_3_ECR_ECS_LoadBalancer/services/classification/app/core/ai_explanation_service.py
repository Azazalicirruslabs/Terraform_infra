    ...
    def _initialize_client(self):
        ...
        try:
            ...
            if os.getenv("AWS_ACCESS_KEY_ID") and os.getenv("AWS_SECRET_ACCESS_KEY"):
                ...
                self.bedrock_client = boto3.client(service_name="bedrock-runtime", region_name=os.getenv("AWS_REGION"))
            logger.info(f"AWS Bedrock client initialized successfully in region {os.getenv('AWS_REGION')}")
