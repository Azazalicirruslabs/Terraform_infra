...
@router.post("/api/feature-importance", tags=["Features"])
async def post_feature_importance(
    ...
    try:
        ...
        # Extract feature importance parameters with defaults
        ...
        try:
            data_preview_response = handle_request(
                model_service.compute_feature_importance_advanced,
                model_overview_payload,
                method,
                sort_by,
                top_n,
                visualization,
